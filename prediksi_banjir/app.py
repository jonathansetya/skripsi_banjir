...
def page_tentang():
    ...
    card('<div style="background:#111827;border:1px solid #1e2d45;border-radius:16px;padding:1.5rem;margin-bottom:1rem;">'
         ...
         'style="width:140px;flex-shrink:0;border-radius:10px;object-fit:cover;border:2px solid #1e2d45;" />'
         '<div style="flex:1;">'
         '<div style="font-size:1.1rem;font-weight:800;color:#f1f5f9;margin-bottom:.3rem;">Jonathan Setya Widayat</div>'
         '<div style="font-size:.8rem;color:#64748b;margin-bottom:.8rem;">NIM: 22104410047</div>'
         ...
         '<div style="font-size:.82rem;color:#cbd5e1;font-weight:500;margin-top:.1rem;">Teknik Informatika</div></div>'
         '<div><div style="font-size:.68rem;color:#64748b;text-transform:uppercase;letter-spacing:.06em;">Tahun Ajaran</div>'
         '<div style="font-size:.82rem;color:#cbd5e1;font-weight:500;margin-top:.1rem;">2022</div></div>'
         '<div style="grid-column:1/-1;">'
         '<div style="font-size:.68rem;color:#64748b;text-transform:uppercase;letter-spacing:.06em;">Dosen Pembimbing</div>'
         '<div style="font-size:.82rem;color:#cbd5e1;margin-top:.1rem;line-height:1.7;">1. Saiful Nur Budiman, S.Kom., M.Kom<br>2. Filda Febrinita, S.Pd., M.Pd</div>'
         '</div></div></div></div></div>')
    # Card 5 — Disclaimer
