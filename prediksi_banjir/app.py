...
def page_tentang():
    ...
    card(
        ...
        '<div style="font-size:.72rem;color:#64748b;text-transform:uppercase;letter-spacing:.08em;margin-bottom:.8rem;">'
        'Informasi Pembuat'
        '</div>'

        '<div style="display:flex;align-items:center;gap:1.4rem;margin-bottom:1.2rem;">'

        '<img src="https://drive.google.com/uc?export=view&id=1FREAIVuUtTO98s1wC8XV-BoV415EEJOH" '
        'onerror="this.style.display=\'none\'" '
        'style="width:220px;flex-shrink:0;border-radius:10px;object-fit:cover;border:2px solid #1e2d45;" />'

        '<div>'
        '<div style="font-size:1.25rem;font-weight:800;color:#f1f5f9;margin-bottom:.4rem;">'
        'Jonathan Setya Widayat'
        '</div>'
        ...
        '<div style="font-size:.85rem;color:#cbd5e1;font-weight:500;margin-top:.15rem;">'
        'Teknik Informatika'
        '</div>'
